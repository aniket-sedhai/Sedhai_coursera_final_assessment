...
/**
 * @brief Moves contents from one pointer to another pointer
 *
 ...
 * @param length - length of data that needs to be moved
 *
...
/**
 * @brief Copies contents from one pointer to another pointer
 *
 ...
 * @param src - Pointer to the source data
 * @param dst - Pointer to the destination
 * @param length - length of data that needs to be copied
 *
 * @return Pointer to the destination.
 */
...
/**
 * @brief Sets the value of pointer elements to a given value
 *
 ...
 *
 * @param src - Pointer to the source data
 * @param length - length of data that needs to be set
 * @param value - value to set the pointer data elements to
 *
...
/**
 * @brief Sets the value of pointer elements to zero
 *
 ...
 *
 * @param src - Pointer to the source data
 * @param length - length of data that needs to be set to zero
 *
 * @return pointer to the source
 */
...
/**
 * @brief Reverses the order of the contents of a pointer
 *
 ...
 *
 * @param src - Pointer to the source data
 * @param length - length of data that needs to be reversed
 *
 * @return pointer to the source
 */
 ...
 *
 * @param src - pointer to the memory that needs to be freed
 *
 * @return void
 */
